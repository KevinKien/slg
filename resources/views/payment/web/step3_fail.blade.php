...
<section class="ContsSubBox v01_layout float_right">
    <h3 class="big floating_left">Bước 3 / 3. Giao dịch thất bại.</h3>
                ...
                <td class="borderStyle" style="border:none" colspan="2">
                    <div class="form-buy cutebox cw364">
                        <p style="text-align:center; padding-top:40px;">
                            <img src="//pay.slg.vn/portal/images/fail_icon.png" width="250px"/>
                        </p>
                        <div class="group-btn">
                            <label class="btn-green" style="float:right;"><input type="button" value="Nạp thêm" onclick="location.href = '{{ url('//pay.slg.vn/topupcash/telco')}}'" id="submit_btn"></label>
                        </div><!--//label-->
                    </div><!--//cw363-->
                </td>
            </tr>
