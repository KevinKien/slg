...
<div class="row">
    ...
    <div class="container">
        ...
        <div class="col-xs-6 col-sm-6 card-panel">
            ...
            <label class="radio-inline" for="card" onclick="location.href = '//pay.slg.vn/mtopupcash2/telco?<?php echo $q ?>';">
        ...
        <div class="col-xs-6 col-sm-6 card-panel">
            ...
            <label class="radio-inline" for="bank" onclick="location.href = '//pay.slg.vn/mtopupcash2/bank?<?php echo $q ?>';">
