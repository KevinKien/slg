...
@section('content')
    <div class="row">
        ...
        <form id="listprovider" name="listprovider" action="{{ url('//pay.slg.vn/mtopupcash2/telco')}}" method="POST">
            <div class="container-fluid">
                ...
                <div>
                    <button onclick="location.href = '{{ url('//pay.slg.vn/mtopupcash2?access_token='.$access_token)}}'"
