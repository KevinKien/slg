...
@section('htmlheader_title')
    Trang liệt kê danh sách apple's product
@endsection
@section('contentheader_title','Danh sách apple product')
@section('main-content')

<div class="row">
    <div class="col-md-3">
              <a class="btn btn-primary btn-block margin-bottom" href="/merchant_app_product_apple/add">THÊM</a>
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="#"><i class="fa fa-inbox"></i>Apple's Product <span class="label label-primary pull-right"><?php
                    $i1=0; 
            ...
            <div class="box-body no-padding">
                ...
                foreach($results as $row){
                    ...
                    $out.="<tr>
                            ...
                            <td>".$row->name."</td>    
                            <td><a href='/merchant_app_product_apple/edit?id=".$row->product_apple_id."'>".$row->title."</a></td>
                            <td>".$row->amount."</td>
                            <td>".number_format($row->money_in_game, 0, '.', ',')."</td>
