        ...
        <div class="col-md-3" >
            <div class="box box-solid">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <form role="form" method="post" name="" action="/log_mwork_topup">
                            ...
                            */
                            ...
                            foreach($result as $row){
                             ...
                             $tt=$page*10-10+$i;
                                //if($i!=0){
                                $amount=$row->amount;
                                $response_array = objectToArray($row->request);
                                $request_data = json_decode($response_array['data']);
                                ?>
                            <tr>
                                <td>{{$tt}}</td>
                                <td>{{$row->uid}}</td>
                                ...
                                <td>{{$row->response}}</td>
                                <td><a tabindex="0" class="btn btn-xs btn-info" role="button" data-toggle="popover" data-html="true" title="Response Content" data-content="<pre>{{var_export($response_array, true)}}</pre>" data-original-title="Request">Request</a> 
                                <td>{{$request_data->telco}}</td>
                                <td>{{$row->time}}</td>
                            </tr>
                                <?php
                               // }  elseif ($i==0){
