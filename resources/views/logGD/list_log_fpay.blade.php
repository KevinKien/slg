        ...
        <div class="col-md-3" >
            <div class="box box-solid">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <form role="form" method="post" name="" action="/log_fpay">
                            ...
                            <div class="form-group">
                                <label> Hãy chọn loại tiền: </label></br>
                                <select id='type' class='form-control' name='type'>
                                <?php
                                    if(!isset($_GET['type'])){
                                        $option1="<option value='TELCO'>Thẻ cào viễn thông</option><option value='CARD'>Thẻ cào fpay</option><option value='TKFPAY'>Tài khoản fpay</option>";
                                    }else{
                                        if($_GET['type']=='TELCO'){
                                            $option1="<option value='TELCO'>Thẻ cào viễn thông</option><option value='CARD'>Thẻ cào fpay</option><option value='TKFPAY'>Tài khoản fpay</option>";
                                        }
                                        if($_GET['type']=='CARD'){
                                            $option1="<option value='CARD'>Thẻ cào fpay</option><option value='TELCO'>Thẻ cào viễn thông</option><option value='TKFPAY'>Tài khoản fpay</option>";   
                                        }
                                        if($_GET['type']=='TKFPAY'){
                                            $option1="<option value='TKFPAY'>Tài khoản fpay</option><option value='CARD'>Thẻ cào fpay</option><option value='TELCO'>Thẻ cào viễn thông</option>";   
                                        }
                                    }
                                    print $option1;
                                ?>
                    ...
                    <div class="box-body">
                        ...
                        if(is_array($result_total)){
                            ...
                            foreach($result_total as $row1){
                                if($row1->amount>0&&$row1->status_game==1){
                                $i1++;
                                $tong+=$row1->amount;
                    ...
                    <table class='table table-hover table-striped'>
                        <thead>
                            <tr>
                                ...
                                if(!isset($_GET['type'])){
                                    ...
                                    if($_GET['type']=='TKFPAY'||$_GET['type']=='CARD'){
                                        $out1='<th>STT</th>
                                                <th>UserId</th>
                                                <th >Username</th>
                                                <th >Loại tiền</th>
                        ...
                        <tbody>
                            ...
                            foreach($result as $row){
                             if($row->amount>0&&$row->status_game==1){
                             $i++;
                             $tt=$page*10-10+$i;
                             $amount=$row->amount;
                             if(!isset($_GET['type'])){
