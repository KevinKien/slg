...
@section('htmlheader_title')
    Trang thống kê doanh thu của Soha
@endsection
@section('contentheader_title','Danh thu Soha')
@section('css-current')
<!-- iCheck -->
        ...
        <div class="col-md-3" >
            <div class="box box-solid">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <form role="form" method="post" name="" action="/log_soha">
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    if(!isset($_GET['appid'])){
                                        $option="<option value='18903324'>Manga đại chiến</option>
                                                   <option value='17054245'>Tứ hoàng đại chiến</option>
                                                   <option value='300000193'>linh vương soha</option>";
                                    }else{
                                        if($_GET['appid']==18903324){
                                            $option="<option value='18903324'>Manga đại chiến</option><option value='17054245'>Tứ hoàng đại chiến</option>";   
                                        }
                                        if($_GET['appid']==17054245){
                                            $option="<option value='17054245'>Tứ hoàng đại chiến</option><option value='18903324'>Manga đại chiến</option>";   
                                        }
                                        if($_GET['appid']==300000193){
                                            $option="<option value='300000193'>linh vương soha</option>
                                                    <option value='18903324'>Manga đại chiến</option>
                                                   <option value='17054245'>Tứ hoàng đại chiến</option>
                                                   ";
                                        }
                                    }
