...
<div id="wrapper">
    ...
    <div class="top-left">
        <!-- Not found text -->
        <div>
            <h1 class="not-found-text">Có lỗi xảy ra khi xử lý yêu cầu của bạn, vui lòng thử lại hoặc liên hệ với chúng tôi.</h1>
        </div>
        <!-- Not found text -->
        ...
        <!-- top menu -->
        <div class="top-menu" style="position:static !important;">
