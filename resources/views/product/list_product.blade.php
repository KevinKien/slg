...
@section('htmlheader_title')
    Trang liệt kê danh sách product
@endsection
@section('contentheader_title','Danh sách product')
@section('main-content')

<div class="row">
    <div class="col-md-3">
              <a class="btn btn-primary btn-block margin-bottom" href="/merchant_app_product/add">THÊM</a>
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="#"><i class="fa fa-inbox"></i> Product <span class="label label-primary pull-right"><?php
                    $i1=0; 
            ...
            <div class="box-body no-padding">
                ...
                foreach($results as $row){
                    ...
                    $out.="<tr>
                            ...
                            <td>".$row->name."</td>
                            <td><a href='/merchant_app_product/edit?productid=".$row->product_id."'>".$row->product_name."</a></td>
                            <td>".number_format($row->product_price,0,'.',',')."</td>
                            <td>".number_format($row->amount_fpay, 0, '.', ',')."</td>
