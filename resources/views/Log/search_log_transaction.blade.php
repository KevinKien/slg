        ...
        <div class="col-md-3" >
            <div class="box box-solid">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <form role="form" method="post" name="" action="/logGD">
                            ...
                            <div class="form-group">
                                ...
                                <select id='card_type' class='form-control' name='card_type'> 
                                    ...
                                    <option value='NganLuong'<?php if(isset($_GET['card_type']) && $_GET['card_type'] == 'NganLuong') {?> selected="selected" <?php } ?> >Ngân Lượng ATM-VISA</option>
                                </select>
                            </div>
                            <div class="form-group">
