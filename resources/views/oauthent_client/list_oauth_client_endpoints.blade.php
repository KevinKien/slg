...
@section('htmlheader_title')
    Trang liệt kê danh sách Oauthent client
@endsection
@section('contentheader_title','Danh sách oauthent client')
@section('main-content')
<div class="row">
   
    <div class="col-md-3">
              <a class="btn btn-primary btn-block margin-bottom" href="/oauth_client_endpoints/add">THÊM</a>
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="#"><i class="fa fa-inbox"></i> OAUTHENT CLIENT <span class="label label-primary pull-right"><?php
                    $i1=0; 
                    foreach($list_total as $row1){
                        $i1=$i1+1;
                        //$tt1=$_GET['page']*10-10+$i1;
            ...
            <div class="box-body no-padding">
               ...
               foreach($list as $row){
                ...
                $out.="<tr>
                        ...
                        <td><a href='oauth_client_endpoints/edit?client_id=".$row->client_id."&id=".$row->id."&secret=".$row->secret."'>".$row->name."</a></td>
                        <td>".$row->redirect_uri."</td>
                        <td>".$row->client_id."</td>
                       <td>".$row->secret."</td>    
