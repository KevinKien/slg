...
game.load = function(container)
{
	...
	{		
		...
		this.height = Math.min(650, window.innerHeight);
	}	
	...
	//load info
	var div = Q.createDOM("div", {innerHTML: "Đang tải dữ liệu，vui lòng chờ...<br>", style:
	{
		id: "loader",
		position: "absolute",
		width: this.width + "px",
...
{
	var content = "Đang tải dữ liệu，vui lòng chờ...<br>(" + Math.round(e.target.getLoadedSize()/e.target.getTotalSize()*100) + "%)";
...
{
	var coin = Number(this.params.coin) || 200;
