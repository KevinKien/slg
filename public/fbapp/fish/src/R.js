...
[
	...
	{id:"mainbg", size:456, src:"https://app.slg.vn/fbapp/fish/images/game_bg_2_hd.jpg?"+Math.random()},
	{id:"bottom", size:50, src:"https://app.slg.vn/fbapp/fish/images/bottom.png?"+Math.random()},
	{id:"fish1", size:6, src:"https://app.slg.vn/fbapp/fish/images/fish1.png?"+Math.random()},
	{id:"fish2", size:16, src:"https://app.slg.vn/fbapp/fish/images/fish2.png?"+Math.random()},
	{id:"fish3", size:11, src:"https://app.slg.vn/fbapp/fish/images/fish3.png?"+Math.random()},
	{id:"fish4", size:15, src:"https://app.slg.vn/fbapp/fish/images/fish4.png?"+Math.random()},
	{id:"fish5", size:43, src:"https://app.slg.vn/fbapp/fish/images/fish5.png?"+Math.random()},
	{id:"fish6", size:45, src:"https://app.slg.vn/fbapp/fish/images/fish6.png?"+Math.random()},
	{id:"fish7", size:80, src:"https://app.slg.vn/fbapp/fish/images/fish7.png?"+Math.random()},
	{id:"fish8", size:100, src:"https://app.slg.vn/fbapp/fish/images/fish8.png?"+Math.random()},
	{id:"fish9", size:104, src:"https://app.slg.vn/fbapp/fish/images/fish9.png?"+Math.random()},
	{id:"fish10", size:121, src:"https://app.slg.vn/fbapp/fish/images/fish10.png?"+Math.random()},
	{id:"shark1", size:287, src:"https://app.slg.vn/fbapp/fish/images/shark1.png?"+Math.random()},
	{id:"shark2", size:382, src:"https://app.slg.vn/fbapp/fish/images/shark2.png?"+Math.random()},
	{id:"cannon1", size:11, src:"https://app.slg.vn/fbapp/fish/images/cannon1.png?"+Math.random()},
	{id:"cannon2", size:11, src:"https://app.slg.vn/fbapp/fish/images/cannon2.png?"+Math.random()},
	{id:"cannon3", size:11, src:"https://app.slg.vn/fbapp/fish/images/cannon3.png?"+Math.random()},
	{id:"cannon4", size:13, src:"https://app.slg.vn/fbapp/fish/images/cannon4.png?"+Math.random()},
	{id:"cannon5", size:13, src:"https://app.slg.vn/fbapp/fish/images/cannon5.png?"+Math.random()},
	{id:"cannon6", size:15, src:"https://app.slg.vn/fbapp/fish/images/cannon6.png?"+Math.random()},
	{id:"cannon7", size:17, src:"https://app.slg.vn/fbapp/fish/images/cannon7.png?"+Math.random()},
	{id:"bullet", size:8, src:"https://app.slg.vn/fbapp/fish/images/bullet.png?"+Math.random()},
	{id:"web", size:93, src:"https://app.slg.vn/fbapp/fish/images/web.png?"+Math.random()},
	{id:"numBlack", size:1, src:"https://app.slg.vn/fbapp/fish/images/number_black.png?"+Math.random()},
	{id:"coinAni1", size:19, src:"https://app.slg.vn/fbapp/fish/images/coinAni1.png?"+Math.random()},
	{id:"coinAni2", size:22, src:"https://app.slg.vn/fbapp/fish/images/coinAni2.png?"+Math.random()},
	{id:"coinText", size:16, src:"https://app.slg.vn/fbapp/fish/images/coinText.png?"+Math.random()}
];
...
R.initResources = function()
{
	...
	mixin:{coin:1, captureRate:0.30, maxNumGroup:8, minSpeed:0.5, maxSpeed:1.2, regX:35, regY:12, useFrames:true, interval:10}};
	...
	mixin:{coin:2, captureRate:0.25, maxNumGroup:6, minSpeed:0.5, maxSpeed:1.2, regX:58, regY:20, useFrames:true, interval:10}};
	...
	mixin:{coin:3, captureRate:0.20, maxNumGroup:6, minSpeed:0.5, maxSpeed:1.2, regX:52, regY:18, useFrames:true, interval:10}};
	...
	mixin:{coin:4, captureRate:0.15, maxNumGroup:6, minSpeed:0.5, maxSpeed:1.2, regX:57, regY:18, useFrames:true, interval:10}};
	...
	mixin:{coin:5, captureRate:0.09, maxNumGroup:5, minSpeed:0.5, maxSpeed:1.2, regX:67, regY:50, useFrames:true, interval:10}};
	...
	mixin:{coin:6, captureRate:0.07, maxNumGroup:3, minSpeed:0.5, maxSpeed:1.2, regX:65, regY:25, useFrames:true, interval:10}};
	...
	mixin:{coin:7, captureRate:0.06, maxNumGroup:5, minSpeed:0.5, maxSpeed:0.8, regX:40, regY:50, useFrames:true, interval:10}};
	...
	mixin:{coin:8, captureRate:0.05, maxNumGroup:3, minSpeed:0.5, maxSpeed:0.8, regX:90, regY:50, useFrames:true, interval:10}};
	...
	mixin:{coin:10, captureRate:0.04, maxNumGroup:2, minSpeed:0.5, maxSpeed:0.8, regX:120, regY:70, useFrames:true, interval:10}};
	...
	mixin:{coin:12, captureRate:0.03, maxNumGroup:2, minSpeed:0.5, maxSpeed:0.8, regX:100, regY:80, useFrames:true, interval:10}};
	...
	mixin:{coin:40, captureRate:0.02, maxNumGroup:1, minSpeed:0.5, maxSpeed:0.6, regX:350, regY:130, useFrames:true, interval:10}};
	...
	mixin:{coin:60, captureRate:0.01, maxNumGroup:1, minSpeed:0.5, maxSpeed:0.6, regX:350, regY:130, useFrames:true, interval:10}};
