...
<body>
    <!-- branding table -->
    <table width='100%' border='2' cellpadding='2' bgcolor='#C1C1C1'><tr><td bgcolor='#E1E1E1' width='90%'><h2 class='co'>&nbsp;Virtual Payment Client - Version 2</h2></td><td bgcolor='#C1C1C1' align='center'><h3 class='co'>Smartlink</h3></td></tr></table>
...
<form action="./VpcDo.php" method="post">
<input type="hidden" name="Title" value="PHP Merchant">
    ...
    <table width="80%" align="center" border="0" cellpadding='0' cellspacing='0'>
	    ...
	    <tr>
	        ...
	        <td><input type="text" name="vpc_AccessCode" value="ECAFAB" size="20" maxlength="20"></td>
	    </tr>
	    <tr bgcolor="#E1E1E1">
	        <td>&nbsp;</td>
	        <td align="right"><b><i>Merchant Transaction Reference: </i></b></td>
	        <td><input type="text" name="vpc_MerchTxnRef" value="SML<?=$merchantTxnRef?>" size="20" maxlength="40"></td>
	    </tr>
	    <tr>
	        <td>&nbsp;</td>
	    ...
	    <tr bgcolor="#E1E1E1">
	        ...
	        <td><input type="text" name="vpc_OrderInfo" value="VPC PHP Merchant Example" size="30"></td>
	    </tr>
	    <tr>
	        <td>&nbsp;</td>
	        <td align="right"><b><i>Purchase Amount: </i></b></td>
	        <td><input type="text" name="vpc_Amount" value="10000" size="20" maxlength="10"></td>
	    </tr>
	    <tr bgcolor="#E1E1E1">
	        <td>&nbsp;</td>
	    ...
	    <tr>
	        <td>&nbsp;</td>
	        <td align="right"><b><i>Currency Code: </i></b></td>
	        <td><input type="text" name="vpc_Currency" value="VND" maxlength="15"></td>
	    </tr>
	    <tr bgcolor="#E1E1E1">
	        <td>&nbsp;</td>
	        <td align="right"><b><i>Receipt ReturnURL: </i></b></td>
	        <td><input type="text" name="vpc_ReturnURL" size="63" value="http://localhost:8081/php_ecom2.0/VpcDr.php" maxlength="250"></td>
	    </tr>
	    <tr>
	        <td>&nbsp;</td>
	        <td align="right"><b><i>Back URL: </i></b></td>
	        <td><input type="text" name="vpc_BackURL" size="63" value="http://localhost:8081/php_ecom2.0/CreateTransaction.php" maxlength="250"></td>
	    </tr>
